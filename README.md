...
From the *CompSci235-A2* directory, and within the activated virtual environment (see *venv\Scripts\activate* above):
...
The *CompSci235-A2/.env* file contains variable settings. They are set with appropriate values.
...
Testing requires that file *CompSci235-A2/tests/conftest.py* be edited to set the value of `TEST_DATA_PATH`. You should set this to the absolute path of the *CompSci235-A2/tests/data* directory. 
